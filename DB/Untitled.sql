...
START TRANSACTION;
USE `soilmatesdb`;
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `email`, `first_name`, `last_name`, `role`, `created_at`, `image_url`) VALUES (1, 'test', '$2a$10$nShOi5/f0bKNvHB8x0u3qOpeivazbuN0NE4TO0LGvQiTMafaBxLJS', 1, NULL, NULL, NULL, 'role', NULL, NULL);
