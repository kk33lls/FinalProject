...
INSERT INTO `plant_species` (`id`, `genus`, `species`, `common_names`, `description`, `light_requirements`, `water_frequency`, `native_to`, `temperature_range`, `image_url`, `enabled`, `care_difficulty_id`) VALUES (4, 'Chlorophytum', 'comosum', 'Spider Plant, Airplane Plant', 'Air-purifying plant with runners.', 'Bright Indirect', 'Weekly', 'South Africa', '65–75°F', 'https://i.imgur.com/Y780m4C.png', 1, 2);
...
INSERT INTO `plant_species` (`id`, `genus`, `species`, `common_names`, `description`, `light_requirements`, `water_frequency`, `native_to`, `temperature_range`, `image_url`, `enabled`, `care_difficulty_id`) VALUES (12, 'Crassula', 'ovata', 'Jade Plant, Money Plant', 'Thick leaves, stores water.', 'Bright Light', 'Every 2-3 weeks', 'South Africa', '65–75°F', 'https://i.imgur.com/ZaJSdvF.jpeg', 1, 6);
