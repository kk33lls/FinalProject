...
START TRANSACTION;
USE `soilmatesdb`;
INSERT INTO `plant_species` (`id`, `genus`, `species`, `common_names`, `description`, `light_requirements`, `water_frequency`, `native_to`, `temperature_range`, `image_url`, `enabled`, `care_difficulty_id`) VALUES (1, 'Ficus', 'elastica', 'Rubber Plant', 'Glossy-leaved beauty, great indoors.', 'Bright indirect', 'weekly', 'Southeast Asia', '60–75°F', 'Ficus Elastica	https://i.imgur.com/jCmXZup.png\nFicus Elastica	https://i.imgur.com/jCmXZup.png\nhttps://i.imgur.com/jCmXZup.png', 1, 3);
