package com.skilldistillery.soilmates.security;
    ...
    SecurityFilterChain createFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(
          authorize -> authorize
            ...
            .requestMatchers(HttpMethod.GET, "/api/plantSpecies/search/*").permitAll()
            .requestMatchers(HttpMethod.GET, "/api/plantSpecies/*").permitAll()
